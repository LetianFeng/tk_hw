 ...
 * 
 */
@WebServiceClient(name = "ServerSoapService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:9999/booking?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9999/booking?wsdl");
