...
The basic setup for ActiveMQ is 5.6.0 running on tcp://localhost:61616. This url can be set using a command line argument. (Eg. java microblog.jar -jar -Dhost="tcp://192.168.1.100:61616")
