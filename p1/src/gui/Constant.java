...
public class Constant {
	...
	final static int loinFrameLength = 450;
	final static int loinFrameWidth = 300;
	
	//game frame properties
	final static int gameFrameX = 100;
	final static int gameFrameY = 100;
	final static int gameFrameWidth = 950;
	final static int gameFrameHeight = 600;
	
	//message frame properties
	final static int messageFrameX = 300;
	final static int messageFrameY = 300;
	final static int messageFrameWidth = 400;
	final static int messageFrameHeight = 200;
